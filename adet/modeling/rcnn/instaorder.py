...
class InstaRCNN(GeneralizedRCNN):
    """
    UOAIS + InstaOrder
    """
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        ...
        if "instances" in batched_inputs[0]:
            ...
            gt_rel_mat = [x["rel_mat"] for x in batched_inputs]
        else:
            gt_instances = None
        ...
        _, detector_losses = self.roi_heads(images, features, proposals, gt_instances, gt_rel_mat)
...
@META_ARCH_REGISTRY.register()
class InstaOrder(GeneralizedRCNN):
    """
    InstaOrder
    """
