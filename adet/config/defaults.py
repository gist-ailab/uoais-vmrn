...
_C.MODEL.ROI_ORDER_HEAD.NAME = "OrderRecoveryHead"
_C.MODEL.ROI_ORDER_HEAD.POOLER_RESOLUTION = 28
_C.MODEL.ROI_ORDER_HEAD.MASK_TYPE = "visible"
_C.MODEL.ORDER_RECOVERY_ON = False
